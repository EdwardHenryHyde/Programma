    ...
    class StatisticheController : IGestioneNegozio
    {
        ...
        public string[] getStatistiche(string dataInizio, string dataFine)
        {
            ...
            if (dataInizio.Contains("marzo"))
            {
                ...
                result[0] = "Numero Scontrini emessi:    " + "800";
                result[1] = "Guadagno lordo:    " + "31021";
                result[2] = "Nuovi Clienti: " + "15";
                result[3] = "Numero premi corrisposti:   " + "11";
                result[4] = "Prodotto piu' venduto:  " + "uovo Kinder";
                return result;
            ...
            {
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 2780;
                result[1] = "Guadagno lordo:    " + 201299;
                result[2] = "Nuovi Clienti: " + 49;
                result[3] = "Numero premi corrisposti:   " + 50;
                result[4] = "Prodotto piu' venduto:  " + "acqua Levissima";
                return result;
            ...
            {
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 602;
                result[1] = "Guadagno lordo:    " + 35329;
                result[2] = "Nuovi Clienti: " + 19;
                result[3] = "Numero premi corrisposti:   " + 73;
                result[4] = "Prodotto piu' venduto:  " + "pandoro Bauli";
                return result;
        ...
        public string[] getReportMensile(string mese)
        {
            ...
            if (mese.Equals("gennaio"))
            {
                ...
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 1237;
                result[1] = "Guadagno lordo:    " + 65000;
                result[2] = "Nuovi Clienti: " + 186;
                result[3] = "Numero premi corrisposti:   " + 38;
                result[4] = "Prodotto piu' venduto:  " + "acqua SanBenedetto";
                return result;
            }
            else if (mese.Equals("febbraio"))
            {
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 923;
                result[1] = "Guadagno lordo:    " + 42432;
                result[2] = "Nuovi Clienti: " + 91;
                result[3] = "Numero premi corrisposti:   " + 15;
                result[4] = "Prodotto piu' venduto:  " + "pasta Barilla";
                return result;
            ...
            {
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 1023;
                result[1] = "Guadagno lordo:    " + 50123;
                result[2] = "Nuovi Clienti: " + 111;
                result[3] = "Numero premi corrisposti:   " + 20;
                result[4] = "Prodotto piu' venduto:  " + "acqua Levissima";
                return result;
            }
            ...
            {
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 1842;
            ...
            {
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 1020;
                result[1] = "Guadagno lordo:    " + 38210;
                result[2] = "Nuovi Clienti: " + 42;
                result[3] = "Numero premi corrisposti:   " + 10;
                result[4] = "Prodotto piu' venduto:  " + "latte Granarolo";
                return result;
            ...
            {
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 940;
                result[1] = "Guadagno lordo:    " + 30212;
                result[2] = "Nuovi Clienti: " + 39;
                result[3] = "Numero premi corrisposti:   " + 9;
                result[4] = "Prodotto piu' venduto:  " + "acqua Guizza";
                return result;
            ...
            else if (mese.Equals("luglio"))
            {
                ...
                result[3] = "Numero premi corrisposti:   " + 27;
                result[4] = "Prodotto piu' venduto:  " + "acqua Levissima";
                return result;
            ...
            {
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 1430;
                result[1] = "Guadagno lordo:    " + 42000;
                result[2] = "Nuovi Clienti: " + 62;
                result[3] = "Numero premi corrisposti:   " + 31;
                result[4] = "Prodotto piu' venduto:  " + "acqua Levissima";
                return result;
            ...
            {
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 2190;
                result[1] = "Guadagno lordo:    " + 70212;
                result[2] = "Nuovi Clienti: " + 112;
                result[3] = "Numero premi corrisposti:   " + 161;
                result[4] = "Prodotto piu' venduto:  " + "quaderni Pigna";
                return result;
            ...
            {
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 1340;
            ...
            else if (mese.Equals("novembre"))
            {
                ...
                result[2] = "Nuovi Clienti: " + 91;
                result[3] = "Numero premi corrisposti:   " + 15;
                result[4] = "Prodotto piu' venduto:  " + "prosciutto di Parma";
                return result;
            ...
            {
                string[] result = new string[5];
                result[0] = "Numero Scontrini emessi:    " + 1212;
                result[1] = "Guadagno lordo:    " + 72012;
                result[2] = "Nuovi Clienti: " + 80;
                result[3] = "Numero premi corrisposti:   " + 91;
                result[4] = "Prodotto piu' venduto:  " + "pandoro Bauli";
                return result;
